...
namespace FubarDev.FtpServer.FileSystem
{
    ...
    public class EmptyUnixFileSystem : IUnixFileSystem
    {
        ...
        /// <inheritdoc/>
        public Task<IBackgroundTransfer?> CreateAsync(IUnixDirectoryEntry targetDirectory, string fileName, Stream data, CancellationToken cancellationToken, long? expectedFileSize)
        {
            throw new NotSupportedException();
        }
