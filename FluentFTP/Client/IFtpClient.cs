...
namespace FluentFTP {
	...
	public interface IFtpClient : IDisposable {
		...
		Stream OpenWrite(string path, long inputFileLengthBytes);
		Stream OpenWrite(string path, FtpDataType type, long inputFileLengthBytes);
		Stream OpenWrite(string path, FtpDataType type, bool checkIfFileExists, long inputFileLengthBytes);
